...
<head>
    ...
    <title>Tarokk</title>
    <link rel="stylesheet" href="css/tarokk.css" type="text/css" />
...
<div id="wraper">
    <div id="Header">
       <a href="logout.php?logout=true" style="float: left">Kijelentkezés</a>
    ...
    <div id="jatekter">
        ...
        <div class="user1Hand" >
            <div id="blockCards">
                <img src="kepek/hatlap.jpg" id="block01">
                <img src="kepek/hatlap.jpg" id="block02">
                <img src="kepek/hatlap.jpg" id="block03">
                <img src="kepek/hatlap.jpg" id="block04">
                <img src="kepek/hatlap.jpg" id="block05">
                <img src="kepek/hatlap.jpg" id="block06">
                <img src="kepek/hatlap.jpg" id="block07">
                <img src="kepek/hatlap.jpg" id="block08">
                <img src="kepek/hatlap.jpg" id="block09">
            </div>
            ...
            <div id="Player1">1. játékos: <span></span></div>
        </div>
        ...
        <div class="user2Hand">
            ...
            <div id="Player2">2. játékos: <span></span></div>
        </div>
        ...
        <div class="user3Hand" >
            ...
            <div id="Player3">3. játékos: <span></span></div>
        </div>
        ...
        <div id="Player4">4. játékos: <span></span></div>
        </div>
</div>
</body>
</html>
